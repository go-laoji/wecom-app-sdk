...
func (app weCom) GroupChatList(filter GroupChatListFilter) (resp GroupChatListResponse) {
...
func (app weCom) GroupChat(request GroupChatRequest) (resp GroupChatResponse) {
...
func (app weCom) GroupOpengId2ChatId(openid string) (resp GroupOpengId2ChatIdResponse) {
	p := H{"openid": openid}
	queryParams := app.buildBasicTokenQuery(app.getAppAccessToken())
...
func (app weCom) GroupChatAddJoinWay(request GroupChatJoinWayRequest) (resp GroupChatAddJoinWayResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (app weCom) GroupChatGetJoinWay(configId string) (resp GetJoinWayResponse) {
...
func (app weCom) GroupChatUpdateJoinWay(request GroupChatJoinWayRequest) (resp internal.BizResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (app weCom) GroupChatDeleteJoinWay(configId string) (resp internal.BizResponse) {
	p := H{"config_id": configId}
	queryParams := app.buildBasicTokenQuery(app.getAppAccessToken())
