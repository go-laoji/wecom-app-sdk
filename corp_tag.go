...
func (app weCom) CorpTagList(tagIds, groupIds []string) (resp CorpTagListResponse) {
...
func (app weCom) CorpTagAdd(tagGroup CorpTagGroup) (resp CorpTagAddResponse) {
	queryParams := app.buildBasicTokenQuery(app.getAppAccessToken())
...
func (app weCom) CorpTagUpdate(tag CorpTag) (resp internal.BizResponse) {
	queryParams := app.buildBasicTokenQuery(app.getAppAccessToken())
...
func (app weCom) CorpTagDelete(tagIds, groupIds []string) (resp internal.BizResponse) {
	p := H{"tag_id": tagIds, "group_id": groupIds}
	queryParams := app.buildBasicTokenQuery(app.getAppAccessToken())
